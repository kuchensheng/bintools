...
func init() {
	Symbols["github.com/kuchensheng/bintools/json/consts/consts"] = map[string]reflect.Value{
		...
		"GlobalPrefix":                 reflect.ValueOf(&consts.GlobalPrefix).Elem(),
		"GlobalTemplate":               reflect.ValueOf(constant.MakeFromLiteral("\"tmp.tmpl\"", token.STRING, 0)),
		...
		"NewBusinessException":         reflect.ValueOf(consts.NewBusinessException),
		"NewBusinessExceptionWithData": reflect.ValueOf(consts.NewBusinessExceptionWithData),
		"NewException":                 reflect.ValueOf(consts.NewException),
		"OBJECT":                       reflect.ValueOf(constant.MakeFromLiteral("\"object\"", token.STRING, 0)),
		"Ok":                           reflect.ValueOf(consts.Ok),
		"OkWithData":                   reflect.ValueOf(consts.OkWithData),
		...
		// type definitions
		"BusinessException": reflect.ValueOf((*consts.BusinessException)(nil)),
	}
}
